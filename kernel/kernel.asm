...
sys_sleep(void)
{
  ...
  while (ticks - ticks0 < n)
    ...
    800034f8:	9e498993          	addi	s3,s3,-1564 # 80238ed8 <tickslock>
    800034fc:	00005497          	auipc	s1,0x5
    80003500:	72448493          	addi	s1,s1,1828 # 80008c20 <ticks>
    if (killed(myproc()))
  ...
  release(&tickslock);
    ...
    80003534:	9a850513          	addi	a0,a0,-1624 # 80238ed8 <tickslock>
  ...
  return 0;
    ...
    80003554:	98850513          	addi	a0,a0,-1656 # 80238ed8 <tickslock>
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    8000359c:	94050513          	addi	a0,a0,-1728 # 80238ed8 <tickslock>
    800035a0:	ffffe097          	auipc	ra,0xffffe
    800035a4:	808080e7          	jalr	-2040(ra) # 80000da8 <acquire>
  xticks = ticks;
    800035a8:	00005497          	auipc	s1,0x5
    800035ac:	6784a483          	lw	s1,1656(s1) # 80008c20 <ticks>
  release(&tickslock);
    800035b0:	00236517          	auipc	a0,0x236
    800035b4:	92850513          	addi	a0,a0,-1752 # 80238ed8 <tickslock>
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    800037ba:	73a50513          	addi	a0,a0,1850 # 80238ef0 <bcache>
  ...
  bcache.head.prev = &bcache.head;
    ...
    800037ca:	72a78793          	addi	a5,a5,1834 # 80240ef0 <bcache+0x8000>
    800037ce:	0023e717          	auipc	a4,0x23e
    800037d2:	98a70713          	addi	a4,a4,-1654 # 80241158 <bcache+0x8268>
    800037d6:	2ae7b823          	sd	a4,688(a5)
  bcache.head.next = &bcache.head;
    800037da:	2ae7bc23          	sd	a4,696(a5)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    800037de:	00235497          	auipc	s1,0x235
    800037e2:	72a48493          	addi	s1,s1,1834 # 80238f08 <bcache+0x18>
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    80003842:	6b250513          	addi	a0,a0,1714 # 80238ef0 <bcache>
  ...
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    ...
    80003852:	95a4b483          	ld	s1,-1702(s1) # 802411a8 <bcache+0x82b8>
    80003856:	0023e797          	auipc	a5,0x23e
    8000385a:	90278793          	addi	a5,a5,-1790 # 80241158 <bcache+0x8268>
    ...
    80003882:	67250513          	addi	a0,a0,1650 # 80238ef0 <bcache>
  ...
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    ...
    800038a0:	9044b483          	ld	s1,-1788(s1) # 802411a0 <bcache+0x82b0>
    800038a4:	0023e797          	auipc	a5,0x23e
    800038a8:	8b478793          	addi	a5,a5,-1868 # 80241158 <bcache+0x8268>
  ...
  panic("bget: no buffers");
    ...
    800038e0:	61450513          	addi	a0,a0,1556 # 80238ef0 <bcache>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    80003988:	56c50513          	addi	a0,a0,1388 # 80238ef0 <bcache>
  ...
  if (b->refcnt == 0) {
    ...
    800039b0:	54478793          	addi	a5,a5,1348 # 80240ef0 <bcache+0x8000>
    800039b4:	2b87b703          	ld	a4,696(a5)
    800039b8:	e8b8                	sd	a4,80(s1)
    b->prev = &bcache.head;
    800039ba:	0023d717          	auipc	a4,0x23d
    800039be:	79e70713          	addi	a4,a4,1950 # 80241158 <bcache+0x8268>
  ...
  release(&bcache.lock);
    ...
    800039d2:	52250513          	addi	a0,a0,1314 # 80238ef0 <bcache>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    80003a0a:	4ea50513          	addi	a0,a0,1258 # 80238ef0 <bcache>
  ...
  release(&bcache.lock);
    ...
    80003a20:	4d450513          	addi	a0,a0,1236 # 80238ef0 <bcache>
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    80003a46:	4ae50513          	addi	a0,a0,1198 # 80238ef0 <bcache>
  ...
  release(&bcache.lock);
    ...
    80003a5c:	49850513          	addi	a0,a0,1176 # 80238ef0 <bcache>
...
bfree(int dev, uint b)
{
  ...
  bp = bread(dev, BBLOCK(b, sb));
    ...
    80003a88:	b487a783          	lw	a5,-1208(a5) # 802415cc <sb+0x1c>
...
0000000080003aee <balloc>:
{
  ...
  for(b = 0; b < sb.size; b += BPB){
    ...
    80003b0c:	aac7a783          	lw	a5,-1364(a5) # 802415b4 <sb+0x4>
    ...
    80003b1c:	a98b0b13          	addi	s6,s6,-1384 # 802415b0 <sb>
...
0000000080003d0e <iget>:
{
  ...
  acquire(&itable.lock);
    ...
    80003d26:	8ae50513          	addi	a0,a0,-1874 # 802415d0 <itable>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    80003d38:	8b448493          	addi	s1,s1,-1868 # 802415e8 <itable+0x18>
    80003d3c:	0023f697          	auipc	a3,0x23f
    80003d40:	33c68693          	addi	a3,a3,828 # 80243078 <log>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    80003d6c:	86850513          	addi	a0,a0,-1944 # 802415d0 <itable>
  ...
  release(&itable.lock);
    ...
    80003d9c:	83850513          	addi	a0,a0,-1992 # 802415d0 <itable>
...
fsinit(int dev) {
  ...
  memmove(sb, bp->data, sizeof(*sb));
    ...
    80003dea:	7ca98993          	addi	s3,s3,1994 # 802415b0 <sb>
  ...
  initlog(dev, &sb);
    ...
    80003e1e:	79658593          	addi	a1,a1,1942 # 802415b0 <sb>
...
0000000080003e4a <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    80003e64:	77050513          	addi	a0,a0,1904 # 802415d0 <itable>
    80003e68:	ffffd097          	auipc	ra,0xffffd
    80003e6c:	eb0080e7          	jalr	-336(ra) # 80000d18 <initlock>
  for(i = 0; i < NINODE; i++) {
    80003e70:	0023d497          	auipc	s1,0x23d
    80003e74:	78848493          	addi	s1,s1,1928 # 802415f8 <itable+0x28>
    80003e78:	0023f997          	auipc	s3,0x23f
    80003e7c:	21098993          	addi	s3,s3,528 # 80243088 <log+0x10>
...
0000000080003eaa <ialloc>:
{
  ...
  for(inum = 1; inum < sb.ninodes; inum++){
    ...
    80003ec4:	6fc72703          	lw	a4,1788(a4) # 802415bc <sb+0xc>
    ...
    80003ed8:	6dca0a13          	addi	s4,s4,1756 # 802415b0 <sb>
...
0000000080003f7c <iupdate>:
{
  ...
  bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80003f94:	6385a583          	lw	a1,1592(a1) # 802415c8 <sb+0x18>
...
0000000080004008 <idup>:
{
  ...
  acquire(&itable.lock);
    ...
    80004018:	5bc50513          	addi	a0,a0,1468 # 802415d0 <itable>
  ...
  release(&itable.lock);
    ...
    8000402e:	5a650513          	addi	a0,a0,1446 # 802415d0 <itable>
...
0000000080004046 <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    80004090:	53c5a583          	lw	a1,1340(a1) # 802415c8 <sb+0x18>
...
0000000080004200 <iput>:
{
  ...
  acquire(&itable.lock);
    ...
    80004212:	3c250513          	addi	a0,a0,962 # 802415d0 <itable>
  ...
  release(&itable.lock);
    ...
    80004230:	3a450513          	addi	a0,a0,932 # 802415d0 <itable>
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    80004264:	37050513          	addi	a0,a0,880 # 802415d0 <itable>
    ...
    8000429a:	33a50513          	addi	a0,a0,826 # 802415d0 <itable>
...
write_head(void)
{
  ...
  struct buf *buf = bread(log.dev, log.start);
    ...
    80004836:	84690913          	addi	s2,s2,-1978 # 80243078 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    8000485a:	85278793          	addi	a5,a5,-1966 # 802430a8 <log+0x30>
    ...
    8000486e:	84260613          	addi	a2,a2,-1982 # 802430ac <log+0x34>
...
00000000800048a0 <install_trans>:
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    800048a4:	8047a783          	lw	a5,-2044(a5) # 802430a4 <log+0x2c>
    800048a8:	0af05d63          	blez	a5,80004962 <install_trans+0xc2>
{
    ...
    800048c6:	7e6a8a93          	addi	s5,s5,2022 # 802430a8 <log+0x30>
  for (tail = 0; tail < log.lh.n; tail++) {
    800048ca:	4a01                	li	s4,0
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    800048cc:	0023e997          	auipc	s3,0x23e
    800048d0:	7ac98993          	addi	s3,s3,1964 # 80243078 <log>
...
0000000080004964 <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    8000497a:	70248493          	addi	s1,s1,1794 # 80243078 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    800049ba:	6f268693          	addi	a3,a3,1778 # 802430a8 <log+0x30>
...
recover_from_log(void)
{
  ...
  log.lh.n = 0;
    ...
    800049ee:	6a07ad23          	sw	zero,1722(a5) # 802430a4 <log+0x2c>
...
begin_op(void)
{
  ...
  while(1){
    ...
    80004a6e:	60e50513          	addi	a0,a0,1550 # 80243078 <log>
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    80004a9e:	5de48493          	addi	s1,s1,1502 # 80243078 <log>
  ...
  if(log.outstanding == 0){
    ...
    80004ac2:	5ba48493          	addi	s1,s1,1466 # 80243078 <log>
...
commit()
{
  if (log.lh.n > 0) {
    ...
    80004ade:	59e48493          	addi	s1,s1,1438 # 80243078 <log>
    ...
    80004b2a:	55248493          	addi	s1,s1,1362 # 80243078 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80004b48:	564a8a93          	addi	s5,s5,1380 # 802430a8 <log+0x30>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    80004b4c:	0023ea17          	auipc	s4,0x23e
    80004b50:	52ca0a13          	addi	s4,s4,1324 # 80243078 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80004bd2:	4c07ab23          	sw	zero,1238(a5) # 802430a4 <log+0x2c>
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    80004bf2:	48a90913          	addi	s2,s2,1162 # 80243078 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80004c30:	47c70713          	addi	a4,a4,1148 # 802430a8 <log+0x30>
  for (i = 0; i < log.lh.n; i++) {
  ...
  log.lh.block[i] = b->blockno;
    ...
    80004c4c:	43078793          	addi	a5,a5,1072 # 80243078 <log>
  ...
  if (i == log.lh.n) {  // Add new block to log?
    ...
    80004c64:	41870713          	addi	a4,a4,1048 # 80243078 <log>
  ...
  log.lh.block[i] = b->blockno;
    ...
    80004c9c:	3e070713          	addi	a4,a4,992 # 80243078 <log>
  ...
  release(&log.lock);
    ...
    80004cae:	3ce50513          	addi	a0,a0,974 # 80243078 <log>
...
void fileinit(void)
{
    ...
    80004e04:	3c050513          	addi	a0,a0,960 # 802431c0 <ftable>
...
filealloc(void)
{
    ...
    80004e52:	37250513          	addi	a0,a0,882 # 802431c0 <ftable>
    ...
    80004e6a:	35a50513          	addi	a0,a0,858 # 802431c0 <ftable>
...
filedup(struct file *f)
{
    ...
    80004e92:	33250513          	addi	a0,a0,818 # 802431c0 <ftable>
    ...
    80004eac:	31850513          	addi	a0,a0,792 # 802431c0 <ftable>
...
void fileclose(struct file *f)
{
    ...
    80004eec:	2d850513          	addi	a0,a0,728 # 802431c0 <ftable>
    ...
    80004f26:	29e50513          	addi	a0,a0,670 # 802431c0 <ftable>
    ...
    80004f70:	25450513          	addi	a0,a0,596 # 802431c0 <ftable>
...
int fileread(struct file *f, uint64 addr, int n)
{
    ...
    800050a2:	08270713          	addi	a4,a4,130 # 80243120 <devsw>
...
int filewrite(struct file *f, uint64 addr, int n)
{
    ...
    80005142:	fe270713          	addi	a4,a4,-30 # 80243120 <devsw>
...
fdalloc(struct file *f)
{
  ...
  for(fd = 0; fd < NOFILE; fd++){
    80005972:	0d850793          	addi	a5,a0,216 # fffffffffffff0d8 <end+0xffffffff7fdbae20>
...
free_desc(int i)
{
  ...
  if(disk.free[i])
    ...
    80006678:	b0478793          	addi	a5,a5,-1276 # 80244178 <disk>
  ...
  disk.desc[i].addr = 0;
    ...
    8000668c:	af078793          	addi	a5,a5,-1296 # 80244178 <disk>
  ...
  wakeup(&disk.free[0]);
    ...
    800066b4:	ae050513          	addi	a0,a0,-1312 # 80244190 <disk+0x18>
...
00000000800066e8 <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    80006700:	ba450513          	addi	a0,a0,-1116 # 802442a0 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_STATUS) = status;
  ...
  features &= ~(1 << VIRTIO_RING_F_INDIRECT_DESC);
    ...
    80006764:	75f70713          	addi	a4,a4,1887 # ffffffffc7ffe75f <end+0xffffffff47dba4a7>
  ...
  *R(VIRTIO_MMIO_QUEUE_SEL) = 0;
  ...
  disk.desc = kalloc();
    ...
    800067ae:	9ce48493          	addi	s1,s1,-1586 # 80244178 <disk>
  ...
  if(!disk.desc || !disk.avail || !disk.used)
    ...
    800067d2:	9b273703          	ld	a4,-1614(a4) # 80244180 <disk+0x8>
  ...
  memset(disk.avail, 0, PGSIZE);
    ...
    800067ea:	99248493          	addi	s1,s1,-1646 # 80244178 <disk>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    8000690a:	99a50513          	addi	a0,a0,-1638 # 802442a0 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    8000691e:	85eb0b13          	addi	s6,s6,-1954 # 80244178 <disk>
  for(int i = 0; i < 3; i++){
  ...
  while(1){
    ...
    8000692a:	97ac0c13          	addi	s8,s8,-1670 # 802442a0 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    8000694c:	83068693          	addi	a3,a3,-2000 # 80244178 <disk>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    8000699a:	0023d517          	auipc	a0,0x23d
    8000699e:	7f650513          	addi	a0,a0,2038 # 80244190 <disk+0x18>
  ...
  if(write)
    ...
    800069be:	7be78793          	addi	a5,a5,1982 # 80244178 <disk>
  ...
  buf0->reserved = 0;
    ...
    800069cc:	7b058593          	addi	a1,a1,1968 # 80244178 <disk>
  ...
  disk.info[idx[0]].status = 0xff; // device writes 0 on success
    ...
    80006a34:	74868693          	addi	a3,a3,1864 # 80244178 <disk>
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    80006aa2:	0023d997          	auipc	s3,0x23d
    80006aa6:	7fe98993          	addi	s3,s3,2046 # 802442a0 <disk+0x128>
  while(b->disk == 1) {
  ...
  disk.info[idx[0]].b = 0;
    ...
    80006ad0:	6ac78793          	addi	a5,a5,1708 # 80244178 <disk>
    80006ad4:	97ba                	add	a5,a5,a4
    80006ad6:	0007b423          	sd	zero,8(a5)
    int flag = disk.desc[i].flags;
    80006ada:	0023d997          	auipc	s3,0x23d
    80006ade:	69e98993          	addi	s3,s3,1694 # 80244178 <disk>
  ...
  release(&disk.vdisk_lock);
    ...
    80006b06:	79e50513          	addi	a0,a0,1950 # 802442a0 <disk+0x128>
  ...
  struct virtio_blk_req *buf0 = &disk.ops[idx[0]];
    ...
    80006b44:	64050513          	addi	a0,a0,1600 # 80244180 <disk+0x8>
  ...
  if(write)
    ...
    80006b5a:	62278793          	addi	a5,a5,1570 # 80244178 <disk>
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    80006b74:	60848493          	addi	s1,s1,1544 # 80244178 <disk>
    80006b78:	0023d517          	auipc	a0,0x23d
    80006b7c:	72850513          	addi	a0,a0,1832 # 802442a0 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  release(&disk.vdisk_lock);
    ...
    80006bf4:	6b050513          	addi	a0,a0,1712 # 802442a0 <disk+0x128>
