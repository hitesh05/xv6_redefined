...
int main(int argc, char **argv)
{
  ...
  18:	86c58593          	addi	a1,a1,-1940 # 880 <malloc+0xf0>
  1c:	4509                	li	a0,2
  1e:	00000097          	auipc	ra,0x0
  22:	686080e7          	jalr	1670(ra) # 6a4 <fprintf>
        exit(1);
  26:	4505                	li	a0,1
  ...
  9a:	80258593          	addi	a1,a1,-2046 # 898 <malloc+0x108>
  9e:	4509                	li	a0,2
  a0:	00000097          	auipc	ra,0x0
  a4:	604080e7          	jalr	1540(ra) # 6a4 <fprintf>
    exit(0);
  a8:	4501                	li	a0,0
