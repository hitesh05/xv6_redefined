...
int main(int argc, char **argv)
{
  ...
  18:	85c58593          	addi	a1,a1,-1956 # 870 <malloc+0xe8>
  1c:	4509                	li	a0,2
  1e:	00000097          	auipc	ra,0x0
  22:	67e080e7          	jalr	1662(ra) # 69c <fprintf>
        exit(1);
  26:	4505                	li	a0,1
  ...
  9a:	7f258593          	addi	a1,a1,2034 # 888 <malloc+0x100>
  9e:	4509                	li	a0,2
  a0:	00000097          	auipc	ra,0x0
  a4:	5fc080e7          	jalr	1532(ra) # 69c <fprintf>
    exit(0);
  a8:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 43a:	47250513          	addi	a0,a0,1138 # 8a8 <digits>
 43e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 506:	3a6b8b93          	addi	s7,s7,934 # 8a8 <digits>
 ...
 646:	25e90913          	addi	s2,s2,606 # 8a0 <malloc+0x118>
        while(*s != 0){
