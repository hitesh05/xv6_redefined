...
user/_priority:     file format elf64-littleriscv
...
int main(int argc,char **argv)
{
  ...
  16:	80e50513          	addi	a0,a0,-2034 # 820 <malloc+0xf0>
  1a:	00000097          	auipc	ra,0x0
  1e:	658080e7          	jalr	1624(ra) # 672 <printf>
        exit(0);
  22:	4501                	li	a0,0
  ...
  44:	85aa                	mv	a1,a0
    priority(new_priority,pid);
  46:	854a                	mv	a0,s2
  48:	00000097          	auipc	ra,0x0
  4c:	34a080e7          	jalr	842(ra) # 392 <priority>
    exit(0);
  50:	4501                	li	a0,0
...
malloc(uint nbytes)
{
 ...
 808:	b6e080e7          	jalr	-1170(ra) # 372 <sbrk>
  if(p == (char*)-1)
